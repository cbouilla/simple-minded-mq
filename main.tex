...
For $D > 4$, the estimating the number of equations is more complicated. As the degree grows, the dimension of polynomials in the polynomial ring $\mathbb{F}_2[x_1, \dots, x_n]$ that are not in the ideal generated by $\{f_1, \dots, f_m\}$ becomes smaller (see Hilbert Function~\cite{Ideals_varieties_algos}), and thus, we obtain more and more trivial relations.
