...
\Copyright{Charles Bouillaguet, Claire Delaplace and Monika Trimoska}
...
\funding{We acknowledge financial support from the French Agence Nationale de la
...
% % The implementation of the F4 algorithm in Magma V2.23-1 solves the system in 9
% % minutes, but it requires 20GB of memory.
...
% The authors thank Sorina Ionica and Gilles Dequen for fruitful discussions. We
% thank Julia Sauvage for her help with the implementation. 
